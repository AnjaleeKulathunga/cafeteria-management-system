...
function Home2() {
  ...
  const slides = [
    {
      image: "https://images.unsplash.com/photo-1544025162-d76694265947?q=80&w=1920",
      subtitle: "BEST PLACE TO DINE",
      title: "MEALMATE"
    },
    {
      image: "https://images.unsplash.com/photo-1543352634-99a5d50ae78e?q=80&w=1920",
      subtitle: "ORDER ANYTIME",
      title: "HOSTEL CAFE"
    },
    {
      image: "https://images.unsplash.com/photo-1543352634-a1c51d9f1fa7?q=80&w=1920",
    ...
    <div className="home-container">
      ...
      <div className="hero-section1">
        <video autoPlay muted loop playsInline>
          <source src="https://assets.mixkit.co/videos/preview/mixkit-food-plate-being-prepared-in-a-kitchen-42937-large.mp4" type="video/mp4" />
        </video>
        <div className="hero-text">
          <h1>
            "Welcome to <span className="highlight">MEAL</span><span className="highlight1">mate</span> Admin Panel!"
          </h1>
          <p className="hero-subtext">
            <i>
              Manage your cafeteria efficiently with our comprehensive admin tools.
              Monitor orders, update menu items, and ensure smooth operations.
            </i>
          </p>
        </div>
      </div>
      ...
      <div className="nav-options">
        ...
        <div className="nav-item">
          ...
          <button onClick={()=> navigate("/adminComplaintTable")}>Complaint</button>
        </div>
        <div className="nav-divider"></div>
        <div className="nav-item">
          <h2>Feedback</h2>
          <p>Contact us for more details</p>
          <button onClick={()=> navigate("/adminfeedback")}>feedback</button>
        </div>
...
"Welcome to Meal Mate! Your go-to website for quick and easy hostel cafeteria orders. Browse the menu, place your order, and enjoy personalized meal suggestions – all at your fingertips!" </div>
      ...
      <div className="iris-blog-section">
        ...
        <div className="iris-blog-cards">
          <a href="#" className="iris-card blog">
          ...
          <a href="./Blog.js" className="iris-card news">
            <div className="card-overlay">
              <span className="arrow-icon">↗</span>
              <h3>SPECIALS</h3>
            </div>
          ...
          <a href="#" className="iris-card case-studies">
            <div className="card-overlay">
              <span className="arrow-icon">↗</span>
              <h3>About Us</h3>
            </div>
        ...
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <div className="footer-contact">
              <p><i className="fas fa-map-marker-alt"></i> MEALmate head office, University Road, Kandy</p>
              <p><i className="fas fa-phone"></i> 071 12345678</p>
